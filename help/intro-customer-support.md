...
在 2 月和 3 月，Adobe 将在此门户中同时设置新的支持系统管理员和支持用户。 如果我们的记录显示您当前在Adobe Admin Console中担任支持系统管理员 — 或者 — 您的姓名在购买合同中被列为Adobe在组织中部署Adobe Campaign和/或Adobe Experience Manager的客户联系人，则您将被设置为组织的支持系统管理员。
